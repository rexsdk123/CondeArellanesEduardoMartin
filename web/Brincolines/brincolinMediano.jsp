<%-- 
    Document   : brincolinMediano
    Created on : 15 nov 2025, 8:16:28 a.m.
    Author     : ArrayLabs
--%>
...
<html>
    <head>
        <title>MERCURY: Brincolin Mediano</title>
        <meta charset="UTF-8">
        ...
        <section class="PP">
            <div class="imgPP">
                <div class="carousel">
                    ...
                    <div class="imagenesSeguimiento">
                        <div class="carousel-slide"><img src="img/brincolinNormal.jpeg" alt="Brincolin Mediano 1"></div>
                        <div class="carousel-slide"><img src="img/brincolinNormal2.jpeg" alt="Brincolin Mediano 2"></div>
                    </div>
            ...
            <div class="infosPP">
                <div class="TextoPP">
                    ...
                    <br>
                    <div class="botonPP">
                        <a href="../pedidosMod.jsp?categoria=1&indexSeleccionado=2"><b>Agregar al carrito</b></a>
                    </div>
                </div>
            </div>
        </section>
